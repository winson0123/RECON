...
import { subSearchResultsMock } from "@/components/table/columns"
...
const SIDEBAR_STATE_NAME = "sidebar:state"
  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        localStorage.setItem(SIDEBAR_STATE_NAME, JSON.stringify(openState))
      },
      [setOpenProp, open]
    )
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn(
        "m-4 flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    >
